...
- [x] Refine the opening after feedback: the source is a tilted 3D field of broad vertical pillars that separate in depth before the particle dissolve; facial detail stays rigid within each pillar rather than bulging from image brightness; mouse movement adds colour without displacement; press-and-hold parts nearby points; the first-frame loader fully covers setup; the interruptible journey to work lasts 6.5 seconds.
