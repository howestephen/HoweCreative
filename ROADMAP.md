...
- [x] Stephen confirmed the first-scroll flicker is resolved on 22 September. Preserve the working hero at `f6067a8`: subsequent work is restricted to the particle form after the case studies, not the portrait, breakup, camera, rendering lifecycle or scroll timing.
...
- [ ] Stephen's review of the new closing form on desktop and phone. The hero must remain unchanged. Opt-in sound review remains outstanding.
