...
- [x] Rework the first-scroll cut after physical Safari and Chrome review showed the first stabilisation pass still flickered and zoomed: keep the camera and rotation completely locked throughout the breakup, begin both only when the released particles disperse into the field, keep the WebGL surface warm across initial wheel and touch input, and retain the deeper pull and broad particle-size distribution biased towards fine points.
