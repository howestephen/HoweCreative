...
- [x] Replace the rigid pillar depth with one continuous field, after Stephen saw hard vertical lines in the phone dissolve that the desktop did not show, and add a camera arc that begins on the first scroll so the opening moves straight away and its depth is visible.
