...
- [ ] Close the vertical seams in the phone dissolve without altering the approved pillar depth. An attempt that replaced the depth model with a continuous field was rejected on 19 September for bulging the face. Try the phone sample density, 400px against the desktop's 640px, since the seams close on desktop through point count alone.
