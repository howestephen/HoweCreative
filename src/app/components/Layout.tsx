      ...
      <header className="fixed top-0 w-full z-50 bg-[#050505]/80 backdrop-blur-md border-b border-[#ff003c]/10">
        <div className="px-6 py-4 flex justify-between items-center">
          <Link to="/" className="text-white font-bold tracking-tighter text-xl group">
            SYS<span className="text-[#ff003c]">_ARCH</span><span className="text-zinc-600 text-sm ml-2">V1.0</span>
          </Link>
          <div className="hidden md:flex gap-8 text-sm font-mono uppercase tracking-widest">
            ...
            <a href="#" className="text-zinc-600 hover:text-[#ff003c] transition-all hover:skew-x-2">
              PROJECTS
            </a>
            <a href="#" className="text-zinc-600 hover:text-[#ff003c] transition-all hover:skew-x-2">
              LABS
          ...
          <button className="bg-[#ff003c] text-black px-4 py-1 font-bold text-xs tracking-widest uppercase transition-all hover:bg-[#8b0020] hover:text-white active:scale-95">
            TERMINAL
          </button>
        </div>
