...
function ChartContainer({
  ...
  const [activeTheme, setActiveTheme] = React.useState<keyof typeof THEMES>("light");
  ...
  React.useEffect(() => {
    ...
    const readTheme = () =>
      root.classList.contains("dark") ? ("dark" as const) : ("light" as const);

    setActiveTheme(readTheme());
